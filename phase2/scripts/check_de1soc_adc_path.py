...
def validate_contract(contract: dict[str, Any]) -> None:
    ...
    for key, expected in {
        ...
        "telemetry_sample_rate_binding": "ADC_continuous_100000_manual_0_otherwise_48000",
...
def validate_board_top(text: str) -> None:
    ...
    for token in (
        ...
        "assigntelemetry_sample_rate_hz=adc_source_enable?(sw_sync[7]?32'd0:ADC_SAMPLE_RATE_HZ_U32):SAMPLE_RATE_HZ_U32;",
        ...
        ")u_adc_wrapper(",
        ".enable_i(adc_source_enable&&!adc_sampling_mode_change)",
