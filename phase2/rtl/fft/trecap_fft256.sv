...
#(
    ...
    parameter int unsigned IN_W           = T_U_W,
    ...
    logic signed [DATA_W-1:0]       input_sample_ext;
    logic                           input_accept;
    logic                           output_accept;
    ...
    always_comb begin
        input_sample_ext = {{(DATA_W-IN_W){in_sample_i[IN_W-1]}}, in_sample_i};
                ...
                unique case (state_q)
                    S_IDLE: begin
                        if (input_accept) begin
                            ...
                            data_re_mem[bitrev_load_addr] <= input_sample_ext;
                            data_im_mem[bitrev_load_addr] <= '0;
